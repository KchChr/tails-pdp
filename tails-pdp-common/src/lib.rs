...
pub const FILE_OPEN_STATIC_POLICY_MAX_ENTRIES: u32 = 8;
pub const FILE_OPEN_STREAM_POLICY_MAX_ENTRIES: u32 = 8;
pub const SOCKET_BIND_STATIC_POLICY_MAX_ENTRIES: u32 = 8;
pub const SOCKET_BIND_STREAM_POLICY_MAX_ENTRIES: u32 = 8;
