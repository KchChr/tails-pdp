...
\begin{description}
    ...
    Der Prototyp muss sicherheitsrelevante Operationen über Linux-Security-Module-Hooks abfangen können.
    
    \textit{Akzeptanzkriterium:} Ein relevanter Zugriff auf eine Ressource wird durch einen LSM-Hook kontrolliert.
...
Im Prototyp betrifft dies insbesondere Zeitinformationen sowie vpm Nutzer frei wählbare Attribute (vlg. FA-12}).
