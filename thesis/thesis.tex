...
Sie beschreiben das Verhalten, das der Prototyp im Rahmen der Arbeit bereitstellen soll.
...
\begin{description}
    ...
    Der Prototyp soll eine einfache Administrationsschnittstelle bereitstellen, über die Policies eingesehen und Attribute in den Kernel geschrieben werden können.
    
    \textit{Akzeptanzkriterium:} Ein Administrator kann zentrale Informationen zum Zustand des Prototyps abrufen und mindestens ein Attribute in den Kernel schreiben.
...
\subsection{Operationale Anforderungen}

Operationale Anforderungen beschreiben, wie gut der Prototyp seine Funktionen im Betrieb erfüllen soll. 
Sie beziehen sich auf Eigenschaften, die für Nutzung, Betrieb und Evaluation sichtbar sind, beispielsweise Stabilität, Sicherheit, Nachvollziehbarkeit, Performance und Reproduzierbarkeit.
