...
Attribute-Based Access Control (ABAC) ist ein Zugriffskontrollmodell, bei dem eine Autorisierungsentscheidung nicht allein anhand einer festen Identität oder Rolle getroffen wird. 
...
NIST beschreibt ABAC als logische Zugriffskontrollmethode, bei der solche Attribute gegen Policies, Regeln oder Beziehungen geprüft werden, um zu entscheiden, ob eine Operation zulässig ist \citep{nistSP800162}.
...
Diese Sichtweise steht inhaltlich in der Nähe von Usage-Control-Modellen. 
...
Gleichzeitig ist eBPF durch Verifier, eingeschränkte Sprachelemente, begrenzten Stack und definierte Hilfsfunktionen deutlich stärker beschränkt als allgemeiner Kernelcode. 
...
Das Aya-Buch weist ebenfalls darauf hin, dass eBPF-Programme ohne Heap auskommen und Daten stattdessen über Maps ablegen müssen \citep{ayaBook}. 
...
Das Aya-Buch beschreibt Aya als Möglichkeit, eBPF-Programme mit Rust zu entwickeln und dabei Cargo, Rust-Strukturen sowie gemeinsame Codeanteile zwischen Userspace und eBPF-Programm zu nutzen \citep{ayaBook}. 
Aya stellt damit eine Alternative zu einer Implementierung auf Basis von C, libbpf oder BCC dar.
...
Ableitung daraus, was Policies genau können und was nicht.
% Inhalt einfügen.
