...
Zielsetzung der Arbeit ist ein Prototyp, anhand dessen eine Zugriffskontrolle mittels SAPL-ähnlicher Attribute Stream-Based Access Control im Linux-Kernel stattfindet.
...
\subsection{SAPL und Policy-Beschreibungen}
% Inhalt einfügen.
...
Die Anforderungen ergeben sich aus der Zielsetzung, zu untersuchen wie SAPL-ähnliche Zugriffskontrolle im Linux-Kernel zu untersuchen und prototypisch umzusetzen.
...
\begin{description}
    ...
    Der Prototyp muss SAPL-ähnliche Policies aus einer definierten Quelle im Userspace einlesen können.
...
\begin{itemize}
    ...
    Die Policyverwaltung liest die SAPL-Policies, parst diese und übersetzt die Policy-Dateien in kernelgeeignete Map-Einträge.
