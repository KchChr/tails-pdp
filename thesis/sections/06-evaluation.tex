...
ruft für die Test-IDs \texttt{E2E-01} bis \texttt{E2E-19} (siehe Tabelle~\ref{tab:e2e-basis}) jeweils eine eigene Bashdatei unter
...
Die vollständige Ausführung von \path{test.sh} wurde mit Exitstatus \texttt{0} abgeschlossen.
...
belastbare Schätzung seltener hoher Latenzen. Da für OA-03 keine feste
