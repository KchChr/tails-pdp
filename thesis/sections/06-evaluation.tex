...
Das Skript \path{test.sh} bündelt die nicht privilegierte Prüfkette. Es führt 52 automatisierte
Rust-Tests in fünf Testbereichen aus. Die Option \texttt{--locked} stellt sicher, dass Cargo dabei die
...
Sechs Tests des Attributloaders prüfen das Parsen der unterstützten Zahlen-, Boolean- und
...
Aktivierungsfehlern untersucht. Zwei
...
Root-Rechten ausgeführt. Das Skript \path{test-e2e.sh} bildet den gemeinsamen Einstiegspunkt und
...
Die Szenarien \texttt{E2E-11} bis \texttt{E2E-17} werden anschließend über
