...
eine bereits laufende E/A-Operation auch nach dem Schließen des Descriptors noch abgeschlossen
werden \citep{manClose}.

Weitere Referenzen auf dieselbe geöffnete Dateibeschreibung können unabhängig vom betrachteten
Descriptor bestehen. \texttt{dup()} erzeugt einen zusätzlichen File Descriptor für dieselbe
...
erzeugte Speicherabbildung nach dem Schließen des zugehörigen File Descriptors bestehen
