...
\subsection{LSM und Linux LSM-Hooks}
...
Der extended Berkeley Packet Filter (eBPF) ist ein Mechanismus, mit dem Programme in einer eingeschränkten Ausführungsumgebung im Linux-Kernel ausgeführt werden können.
