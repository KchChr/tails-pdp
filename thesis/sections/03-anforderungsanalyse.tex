...
\begin{description}
    ...
    Der Prototyp muss bereits bestehende Dateizugriffe überwachen und versuchen, sie durch Schließen des betroffenen File Descriptors zu beenden, wenn sie durch entscheidungsrelevante Policy- oder Attributänderungen unzulässig werden.
    ...
    Der Userspace-PEP ermittelt den zugehörigen Prozess und File Descriptor, bewertet den Zugriff anhand der aktuellen Policy- und Attributlage und führt bei einer erkannten Verletzung einen gezielten Schließversuch im Zielprozess aus.
